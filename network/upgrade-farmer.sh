...
# Upgrade farmer chaincode to v2 with full farmer details in queries

CC_NAME="farmer"
CC_VERSION="2"
CC_PATH="../chaincode/farmer"
...
echo "✓ ${CC_NAME} v${CC_VERSION} upgraded successfully!"

# Verify
echo ""
echo "Verifying deployment..."
docker exec cli peer lifecycle chaincode querycommitted --channelID insurance-main --name ${CC_NAME}
